...
public class VueloBL {
    ...
    public ArrayList<Vuelo> GetAllVuelos( ) throws AppException{
        try {
            ...
            while(rs.next())    {
                Vuelo v = new Vuelo(rs.getInt("ID_VUELO"), rs.getString("ESTADO"), 
                                    rs.getInt("TIPO_VUELO"), rs.getString("LUGAR_PARTIDA"), 
                                    rs.getString("LUGAR_DESTINO"), rs.getInt("PRECIO_POR_PERSONA"), 
                                    rs.getString("RECOMENDACION"), rs.getString("CLASE_VUELO"), 
                                    rs.getString("LATAM_PASS"), rs.getInt("CLASE_PRECIO"), 
