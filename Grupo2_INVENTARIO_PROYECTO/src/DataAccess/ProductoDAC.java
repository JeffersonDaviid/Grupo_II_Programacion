...
public class ProductoDAC extends DataHelper {
     ...
     * 
     * @param pro : del tipo Producto la cual es la entidad donde se alojan las variables, getters y setters del producto
     ...
     * 
     * @return : retorna el producto que se encuentra en la tabla Productos de la Base de Datos
     * @throws AppException : indica las excepciones que se pueden lanzar durante la ejecución, especificadas en la clase AppException
     */
    ...
    /**
     * Permite obtener un producto de la Base de Datos por medio de su categoría específica
     * 
    ...
    /**
     * Obtiene un producto de la Base de Datos por medio del código o del id del producto enviado
     * 
    ...
    /**
     * Permite realizar cambios en las características de un producto, utilizado cuando se requiere actualizar un producto
     * 
     * @param id : envia un nuevo id si se modifica dicho valor en la tabla de actualizar
     * @param codigo : envia un nuevo código si se modifica dicho valor en la tabla de actualizar
     * @param estado : envia un nuevo estado si se modifica dicho valor en la tabla de actualizar
     * @param categoriaProducto : envia un nuevo categoría si se modifica dicho valor en la tabla de actualizar
     * @param iva : envia un nuevo iva si se modifica dicho valor en la tabla de actualizar
     * @param producto : envia un nuevo nombre del producto si se modifica dicho valor en la tabla de actualizar
     * @param stock : envia un nuevo stock si se modifica dicho valor en la tabla de actualizar
     * @param precioCompra : envia un nuevo precio de compra si se modifica dicho valor en la tabla de actualizar
     * @param precioVenta : envia un nuevo precio de venta si se modifica dicho valor en la tabla de actualizar
     * @param descripcion : envia una nueva descripcion si se modifica dicho valor en la tabla de actualizar
     * @param imagen : envia una nueva imagen si se modifica dicho valor en la tabla de actualizar
     * @param fechaModificacion : envia una fecha de modificación  si se modifica dicho valor en la tabla de actualizar
     * @return : retorna el producto con los atributos actualizados según hayan sido modificados
    ...
    public boolean setProducto(String id, String codigo, int estado, int categoriaProducto, int iva, String producto,
            int stock, float precioCompra, float precioVenta, String descripcion, ImageIcon imagen, String fechaModificacion)
            throws Exception {
        try {
            String sql = "UPDATE "
                    + APP.BASE_DATOS_MYSQL.TABLA_PRODUCTO
