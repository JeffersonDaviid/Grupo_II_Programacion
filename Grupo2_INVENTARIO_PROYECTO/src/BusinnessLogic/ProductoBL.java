...
public class ProductoBL {
    ...
    /**
     * Obtiene todos los productos registrados en la BD y los almacena en un ArrayList de tipo Producto
     * 
     ...
     * 
     * @return : retorna un Arraylist de todos los productos disponibles / no disponibles clasificados por categoría
     * @throws Exception : indica las excepciones que se pueden lanzar durante la ejecución
     */
     ...
     * 
     * @param nuevoProducto : recibe un objeto de tipo Producto lo cual permite crear un producto
     ...
     * El objetivo de este método es respetar la arquitectura y pasar de la capa DAC a la Bl y luego a la GUI
     * 
     * @param cbxIvaProducto : recibe un comboBox dado que los datos obtenidos se van a presentar en dicho componente
     */
